    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between font-sans">
      ...
      <main className="flex-1 max-w-lg w-full mx-auto px-4 py-12 flex flex-col justify-center">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-slate-500 mt-1">Select your account profile to continue</p>
      ...
      <footer className="py-4 text-center text-[11px] text-slate-400 border-t border-slate-200">
        MedPass AI Enterprise • IRDAI Cashless Everywhere Standards
      </footer>
    </div>
  );
};
